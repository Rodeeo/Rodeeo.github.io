const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=9633e248f32005ad22af91d87fd487ee";
fetch(apiURL)
...
if (temp <= 50  && windspeed >= 3) {
  ...
  const apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=da65eb66c969087514d2a228682d94b6";
  fetch(apiURL2)
  .then((response) => response.json())
  .then((jsObject) => {
